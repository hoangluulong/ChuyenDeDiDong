...
public class ThongBaoKhoaCuaHangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("ADMIN/ThongBaoKhoaCuaHang");
                ...
                if (text.isEmpty()) {
                    ...
                    mDatabase.setValue(text).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(ThongBaoKhoaCuaHangActivity.this, "Đã lưu!", Toast.LENGTH_LONG).show();
                            btn_luu.setEnabled(true);
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(ThongBaoKhoaCuaHangActivity.this, "Thất bại!", Toast.LENGTH_LONG).show();
                            btn_luu.setEnabled(true);
                        }
                    });
                }
