...
import java.android.quanlybanhang.function.CuaHangOnline.Adapter.ItemDiaChiAdapter;
 ...
 * Use the {@link ChoXacNhanQuangCaoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChoXacNhanQuangCaoFragment extends Fragment implements View.OnClickListener {
    ...
    public ChoXacNhanQuangCaoFragment() {
    ...
    public static ChoXacNhanQuangCaoFragment newInstance(String param1, String param2) {
        ChoXacNhanQuangCaoFragment fragment = new ChoXacNhanQuangCaoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cho_xac_nhan_quang_cao, container, false);
        IDLayout(view);
...
//        String image = "https://firebasestorage.googleapis.com/v0/b/quanlybanhang-26023.appspot.com/o/hinhanh%2F1636025388526.jpg?alt=media&token=df6d34c4-a532-4128-abe7-9c25fb49b8b4";
//        listQuanCao.add(new SanPhamQuangCao("UhgvHGvgnbGHHG", "key", "Redbull",
//                30, 20000, 5000, "Đồ không ga", "Mô tả mô tả", "1636025388526.jpg", image, true, "20-11-2021", "15-10-2021"));
//        listQuanCao.add(new SanPhamQuangCao("UhgvHGvgnbGHHG", "key", "Redbull",
//                30, 20000, 5000, "Đồ không ga", "Mô tả mô tả", "1636025388526.jpg", image, true, "20-11-2021", "15-10-2021"));
//        listQuanCao.add(new SanPhamQuangCao("UhgvHGvgnbGHHG", "key", "Redbull",
//                30, 20000, 5000, "Đồ không ga", "Mô tả mô tả", "1636025388526.jpg", image, true,"20-11-2021", "15-10-2021"));
...
//                30, 20000, 5000, "Đồ không ga", "Mô tả mô tả", "1636025388526.jpg", image, true,"20-11-2021", "15-10-2021"));
        ...
        ChildEventListener childEventListener = new ChildEventListener() {
            ...
            public void onChildMoved(DataSnapshot dataSnapshot, String previousChildName) {
                Log.d("qqqq", dataSnapshot.getValue()+"");
            }
            @Override
